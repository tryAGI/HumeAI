...
namespace HumeAI
{
    ...
    public sealed partial class ReturnPagedPrompts
    {
        ...
        public global::System.Collections.Generic.IList<global::HumeAI.ReturnPrompt>? PromptsPage { get; set; }
        ...
        public ReturnPagedPrompts(
            ...
            int? pageSize,
            int? totalPages,
            global::System.Collections.Generic.IList<global::HumeAI.ReturnPrompt>? promptsPage)
        {
