...
namespace HumeAI
{
    public partial class EviToolsClient
    {
        ...
        private static readonly global::HumeAI.EndPointSecurityRequirement s_UpdateEviToolNameSecurityRequirement1 =
            new global::HumeAI.EndPointSecurityRequirement
            {
                Authorizations = new global::HumeAI.EndPointAuthorizationRequirement[]
                {                    new global::HumeAI.EndPointAuthorizationRequirement
        ...
        private static readonly global::HumeAI.EndPointSecurityRequirement[] s_UpdateEviToolNameSecurityRequirements =
            ...
            {                s_UpdateEviToolNameSecurityRequirement0,
                s_UpdateEviToolNameSecurityRequirement1,
            };
        partial void PrepareUpdateEviToolNameArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string id,
            global::HumeAI.PostedUserDefinedToolName request);
        partial void PrepareUpdateEviToolNameRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string id,
            global::HumeAI.PostedUserDefinedToolName request);
        partial void ProcessUpdateEviToolNameResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessUpdateEviToolNameResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<string> UpdateEviToolNameAsync(
            string id,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::HumeAI.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::HumeAI.AutoSDKHttpResponse<string>> UpdateEviToolNameAsResponseAsync(
            string id,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareUpdateEviToolNameArguments(
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareUpdateEviToolNameRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::HumeAI.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::HumeAI.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "UpdateEviToolName",
                                methodName: "UpdateEviToolNameAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessUpdateEviToolNameResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::HumeAI.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessUpdateEviToolNameResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    return new global::HumeAI.AutoSDKHttpResponse<string>(
        ...
        public async global::System.Threading.Tasks.Task<string> UpdateEviToolNameAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::HumeAI.PostedUserDefinedToolName
            {
                Name = name,
            };

            return await UpdateEviToolNameAsync(
                id: id,
                request: __request,
                requestOptions: requestOptions,
