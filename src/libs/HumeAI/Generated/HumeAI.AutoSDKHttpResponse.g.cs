...
namespace HumeAI
{
    ...
    public sealed class AutoSDKConditionalResponse<T>
    {
        internal AutoSDKConditionalResponse(
            bool notModified,
            string? entityTag,
            global::HumeAI.AutoSDKHttpResponse<T>? response)
        {
        ...
        public global::HumeAI.AutoSDKHttpResponse<T>? Response { get; }
    }
    ...
    public static class AutoSDKConditionalRequests
    {
        ...
        /// </summary>
        public static async global::System.Threading.Tasks.Task<global::HumeAI.AutoSDKConditionalResponse<T>> SendAsync<T>(
            global::System.Func<global::HumeAI.AutoSDKRequestOptions, global::System.Threading.CancellationToken, global::System.Threading.Tasks.Task<global::HumeAI.AutoSDKHttpResponse<T>>> send,
            string? entityTag = null,
            global::HumeAI.AutoSDKRequestOptions? requestOptions = null,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return new global::HumeAI.AutoSDKConditionalResponse<T>(
                    notModified: false,
                    entityTag: GetEntityTag(response.Headers),
                    response: response);
            }
            catch (global::HumeAI.ApiException exception)
        ...
        private static global::HumeAI.AutoSDKRequestOptions CloneRequestOptions(
            global::HumeAI.AutoSDKRequestOptions? source)
        {
            var clone = new global::HumeAI.AutoSDKRequestOptions();
            if (source == null)
            {
                return clone;
            }
