...
namespace HumeAI
{
    ...
    public sealed class AutoSDKClientOptions
    {
        ...
        /// </summary>
        public global::HumeAI.AutoSDKRetryOptions Retry { get; set; } = new global::HumeAI.AutoSDKRetryOptions();
        ...
        /// </summary>
        public global::System.Collections.Generic.List<global::HumeAI.IAutoSDKHook> Hooks { get; } =
            new global::System.Collections.Generic.List<global::HumeAI.IAutoSDKHook>();
        ...
        public global::HumeAI.AutoSDKClientOptions AddHook(
            global::HumeAI.IAutoSDKHook hook)
        {
        ...
        /// </summary>
        public global::HumeAI.IAutoSDKAuthorizationProvider? AuthorizationProvider { get; set; }
        ...
        public global::HumeAI.AutoSDKClientOptions UseAuthorizationProvider(
            global::HumeAI.IAutoSDKAuthorizationProvider provider)
        {
            AuthorizationProvider = provider ?? throw new global::System.ArgumentNullException(nameof(provider));
            if (Hooks.Find(static x => x is global::HumeAI.AutoSDKAuthorizationProviderHook) == null)
            {
                Hooks.Add(new global::HumeAI.AutoSDKAuthorizationProviderHook());
            }
    ...
    public readonly struct AutoSDKAuthorizationValue
    {
        ...
        public static global::HumeAI.AutoSDKAuthorizationValue Bearer(string token) => new(value: token, scheme: "Bearer");

        /// <summary>Convenience factory for an API-key header.</summary>
        public static global::HumeAI.AutoSDKAuthorizationValue ApiKeyHeader(string name, string value) =>
    ...
    public interface IAutoSDKAuthorizationProvider
    {
        ...
        global::System.Threading.Tasks.Task<global::System.Collections.Generic.IReadOnlyList<global::HumeAI.AutoSDKAuthorizationValue>?> ResolveAsync(
            global::HumeAI.AutoSDKHookContext context);
    }
...
#pragma warning restore CS0618
    ...
    /// </summary>
    public sealed class AutoSDKAuthorizationProviderHook : global::HumeAI.AutoSDKHook
    {
        /// <inheritdoc />
            ...
            global::HumeAI.AutoSDKHookContext context)
        {
            ...
            if (perRequest != null && perRequest.Count > 0)
            {
                ...
                global::HumeAI.AutoSDKHttpRequestOptions.StampAuthorizationOverride(context.Request);
                return;
            }
        ...
        private static void ApplyAuthorization(
            global::System.Net.Http.HttpRequestMessage request,
            global::HumeAI.AutoSDKAuthorizationValue authorization)
        {
    ...
    public sealed class AutoSDKRequestOptions
    {
        ...
        /// </summary>
        public global::HumeAI.AutoSDKRetryOptions? Retry { get; set; }
        ...
        /// </summary>
        public global::System.Collections.Generic.IReadOnlyList<global::HumeAI.AutoSDKAuthorizationValue>? Authorizations { get; set; }
    }
    ...
    /// </summary>
    public abstract class AutoSDKHook : global::HumeAI.IAutoSDKHook
    {
        /// <inheritdoc />
    ...
    public sealed class AutoSDKHookContext
    {
        ...
        /// </summary>
        public global::HumeAI.AutoSDKClientOptions ClientOptions { get; set; } = null!;

        /// <summary>
        /// The per-request runtime options.
        /// </summary>
        public global::HumeAI.AutoSDKRequestOptions? RequestOptions { get; set; }
    ...
    internal static class AutoSDKRequestOptionsSupport
    {
        ...
        private static async global::System.Threading.Tasks.Task InvokeHooksAsync(
            global::HumeAI.AutoSDKClientOptions clientOptions,
            global::System.Func<global::HumeAI.IAutoSDKHook, global::HumeAI.AutoSDKHookContext, global::System.Threading.Tasks.Task> callback,
            global::HumeAI.AutoSDKHookContext context)
        {
