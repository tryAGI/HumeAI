...
namespace HumeAI
{
    ...
    public sealed partial class ReturnTimeoutSpecs
    {
        ...
        public global::HumeAI.ReturnTimeoutSpec? Inactivity { get; set; }

        /// <summary>
        /// 
        /// </summary>
        [global::System.Text.Json.Serialization.JsonPropertyName("max_duration")]
        public global::HumeAI.ReturnTimeoutSpec? MaxDuration { get; set; }
        ...
        public ReturnTimeoutSpecs(
            global::HumeAI.ReturnTimeoutSpec? inactivity,
            global::HumeAI.ReturnTimeoutSpec? maxDuration)
        {
