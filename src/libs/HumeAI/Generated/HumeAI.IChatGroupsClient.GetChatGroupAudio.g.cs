...
namespace HumeAI
{
    public partial interface IChatGroupsClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::HumeAI.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::HumeAI.AutoSDKHttpResponse<global::HumeAI.ReturnChatGroupPagedAudioReconstructions>> GetChatGroupAudioAsResponseAsync(
            string id,
            int? pageNumber = default,
            int? pageSize = default,
            bool? ascendingOrder = default,
